...
{
    public class DEl_Player : KinematicBody2D
    {
        #region Const
        ...
        private void Animate()
        {
            ...
            if (_linearVelocity.x == 0 && _linearVelocity.y == 0 && Input.IsActionPressed(MoveSit) && IsOnFloor())
            {
        ...
        private void Jump()
        {
            if (Input.IsActionPressed(MoveSit))
            {
                return;
            }
